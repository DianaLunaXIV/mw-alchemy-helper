...
describe("When ingredient selection includes all DLC", () => {
  ...
  it("returns all ingredients", () => {
    let expectedLength: Number =
      ...
      Object.keys(Ingredients.bloodmoonIngredients).length +
      Object.keys(Ingredients.tribunalIngredients).length;
  ...
  it("can retrieve an individual Tribunal ingredient", () => {
    let timsaComeByFlowers: Ingredient | undefined = Ingredients.findByName(
